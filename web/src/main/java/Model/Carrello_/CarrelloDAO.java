...
public class CarrelloDAO {
    public ArrayList<Integer> doRetriveByMailCliente(String mail) throws SQLException {
        ...
        PreparedStatement pdstmt = con.prepareStatement("SELECT PezzoID FROM Comporre WHERE CarrelloCod IN (SELECT Mail FROM Ordine WHERE ClienteMail = ? AND Evaso != true);");
